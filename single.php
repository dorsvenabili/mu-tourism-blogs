				...
				<div id="main" class="left-align">
					<div id="container">
						...
						<div id="content">
							...
							<div class="post" id="post" style="background-image:none;">
							...
							<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
									...
									<div class="entry-meta">
										...
										<?php /*?>
										<!-- Mostramos el botón de facebook -->
										<div id="boton-facebook"><?php if (function_exists('Count_Button')){ echo Count_Button(); } ?></div>
...
<?php endwhile; ?>
									...
									<div id="more-content" class="l-post-c">
										<div class="lmc">
											...
											<h2 class="tit-related-news">Noticias relacionadas</h2>
											<?php 
